    ...
    # Plasma-manager config. Update with `nix run github:nix-community/plasma-manager`
    {
      ...
      programs.plasma = {
        ...
        shortcuts = {
          ...
          "systemsettings.desktop"._launch = ["Tools" "Meta+/\\, "];
        ...
        configFile = {
          ...
          kcminputrc."Libinput/1267/16699/ELAN901C:00 04F3:413B".Enabled = false;
          ...
          kwinrc."Tiling/3fccc1de-8abb-509c-92cc-83eaf429f20c".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
          ...
          kwinrc."Tiling/9b4915bb-41fd-5c29-82a2-a2575247d279".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
          ...
          kwinrc."Tiling/f5665821-cbe0-585d-9252-bd57b650ff34".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
