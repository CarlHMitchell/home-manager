{
  ...
  programs.fish = {
    ...
    functions = {
      ls = {
        body = "eza --color=auto --group-directories-first --classify $argv";
      };
      la = {
        body = "eza --color=auto --group-directories-first --classify --all $argv";
      };
      ll = {
        body = "eza --color=auto --group-directories-first --classify --all --long --header --group $argv";
      };
      aws_id = {
