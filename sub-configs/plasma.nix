# Plasma-manager config. Update with `nix run github:nix-community/plasma-manager`
{
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-e365ac78-eeaa-4551-b27b-0c7b63b8b25f" = "none";
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to English (Colemak)" = "none";
      ...
      "mediacontrol"."playpausemedia" = ["Media Play" "Meta+Space\\,Media Play\\,Play/Pause media playback"];
      ...
      "org.kde.krunner.desktop"."_launch" = ["Alt+Space" "Search" "Alt+F2" "Meta+R\\,Alt+Space" "Alt+F2" "Search\\,KRunner"];
    ...
    configFile = {
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "eDP-1\x3d1;DP-1\x3d1;HDMI-1\x3d1;DP-2\x3d1;DP-3\x3d1;DP-4\x3d1;DP-5\x3d1;";
      ...
      "khotkeysrc"."General"."XftAntialias" = "";
      ...
      "kwinrc"."Tiling/0641a98f-3ce7-5b36-aeb2-ba8b03c59aaf"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
      ...
      "kwinrc"."Tiling/8e1888f2-f9e7-5b13-b713-be0ea3260fea"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
      ...
      "kwinrc"."Tiling/d369b937-097f-5d8c-8430-52e221cb3551"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/flake.nix"."TextFolding" = "{\"checksum\":\"1a217f110e44db45bd0ab114b5b6dc1cbd90f291\",\"ranges\":\x5b\x5d}";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/home-manager\\/home.nix"."TextFolding" = "{\"checksum\":\"b30dacfd2d8f96ef3f5b89b5fbe2ca0b566db4c2\",\"ranges\":\x5b\x5d}";
