# Plasma-manager config. Update with `nix run github:nix-community/plasma-manager`
{
  ...
  programs.plasma = {
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."Highlighting" = "Nix";
      ...
      "kate/anonymous.katesession"."Document 0"."Mode" = "Nix";
      "kate/anonymous.katesession"."Document 0"."Mode Set By User" = false;
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/carl/tmp/nix_config/flake.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "311,1564,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 946;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-2-Splitter" = 1564;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1489;
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 1564;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = "file:///home/carl/tmp/nix_config/home-manager/home.nix";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Count" = 2;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Documents" = "file:///home/carl/tmp/nix_config/flake.nix,file:///home/carl/tmp/nix_config/home-manager/home.nix";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 0" = "file:///home/carl/tmp/nix_config/flake.nix";
