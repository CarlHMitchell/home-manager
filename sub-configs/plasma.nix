# Plasma-manager config. Update with `nix run github:nix-community/plasma-manager`
{
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-e365ac78-eeaa-4551-b27b-0c7b63b8b25f" = [];
      ...
      "kwin"."Window Move" = "Meta+Pause,,Move Window";
      ...
      "org.kde.dolphin.desktop"."_launch" = "Meta+E,none";
      "org.kde.kcalc.desktop"."_launch" = "Launch (1),none";
      ...
      "org.kde.spectacle.desktop"."RectangularRegionScreenShot" = "Meta+Shift+Print,none";
      "org.kde.spectacle.desktop"."WindowUnderCursorScreenShot" = "Meta+Ctrl+Print,none";
      "org.kde.spectacle.desktop"."_launch" = "Print,none";
      ...
      "systemsettings.desktop"."_launch" = ["Tools" "Meta+/,none"];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."e365ac78-eeaa-4551-b27b-0c7b63b8b25f" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "e365ac78-eeaa-4551-b27b-0c7b63b8b25f";
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "eDP-1x3d1;DP-1x3d1;HDMI-1x3d1;DP-2x3d1;DP-3x3d1;DP-4x3d1;DP-5x3d1;";
      "kdeglobals"."KScreen"."XwaylandClientsScale" = false;
      "kdeglobals"."WM"."activeBackground" = "221,227,237";
      "kdeglobals"."WM"."activeBlend" = "221,227,237";
      "kdeglobals"."WM"."activeForeground" = "35,38,41";
      "kdeglobals"."WM"."inactiveBackground" = "235,239,244";
      "kdeglobals"."WM"."inactiveBlend" = "235,239,244";
      "kdeglobals"."WM"."inactiveForeground" = "98,117,147";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{712056b9-c68d-49ce-8d7e-5c0304c95aee}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{0b4d5e41-a2f0-4788-9005-64e275bd3c98}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{f1050358-6469-4dbb-9db4-9f894161dd86}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{609a2720-2936-4798-9d0b-c637ed40a563}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{70d4b66c-9a68-4f4e-915e-d20023a490af}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{0cb95801-249f-457d-9be1-3172676b975f}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{1686ac51-98b4-4feb-819a-b1e758a46d28}";
      ...
      "kwalletrc"."Auto Allow"."kdewallet" = "Google Chrome,Code,kded5,Slack,Chromium";
      ...
      "kwinrc"."Desktops"."Id_1" = "d796b195-c42b-407d-bc71-e8dff62f5b52";
      ...
      "kwinrc"."Tiling/0641a98f-3ce7-5b36-aeb2-ba8b03c59aaf"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/0f40035a-6988-5f83-bef2-a1568ddc586c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/29058f60-d981-5cea-b9be-bfbdfec110ef"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/6b252c5c-fb6e-5a7d-b9bf-2c6d362e3df7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/8e1888f2-f9e7-5b13-b713-be0ea3260fea"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/a1c18174-a5fa-52cf-adfb-84066eaec20d"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/d369b937-097f-5d8c-8430-52e221cb3551"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kxkbrc"."Layout"."DisplayNames" = "";
      "kxkbrc"."Layout"."LayoutList" = "us";
      "kxkbrc"."Layout"."Options" = "compose:rctrl,caps:escape_shifted_capslock";
      "kxkbrc"."Layout"."ResetOldOptions" = true;
      "kxkbrc"."Layout"."Use" = true;
      "kxkbrc"."Layout"."VariantList" = "colemak";
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasma-localerc"."Formats"."LC_TIME" = "en_US.UTF-8";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."Highlighting" = "YAML";
      ...
      "kate/anonymous.katesession"."MainWindow0"."3 screens: Height" = 967;
      "kate/anonymous.katesession"."MainWindow0"."3 screens: Width" = 1920;
      "kate/anonymous.katesession"."MainWindow0"."Active ViewSpace" = 0;
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "0,1876,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-LastSize" = 311;
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-SectSizes" = 0;
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 861;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 861;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-2-Splitter" = 1876;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1461;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,861,0";
      "kate/anonymous.katesession"."MainWindow0"."ToolBarsMovable" = "Disabled";
      "kate/anonymous.katesession"."MainWindow0 Settings"."3 screens: Height" = 967;
      "kate/anonymous.katesession"."MainWindow0 Settings"."3 screens: Width" = 1920;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/code\\/KeepTruckin\\/kt\\/.tekton\\/embedded\\/pipelineruns\\/test-via_app.yaml"."JumpList" = "";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/code\\/KeepTruckin\\/kt\\/.tekton\\/embedded\\/pipelineruns\\/test-via_app.yaml"."TextFolding" = "{\"checksum\":\"8b6260a943a7c71355199f1f8ca02fedf0d997ff\",\"ranges\":[]}";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/code\\/KeepTruckin\\/kt\\/.tekton\\/embedded\\/pipelineruns\\/test-via_app.yaml"."ViMarks" = "";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/flake.nix"."CursorColumn" = 6;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/flake.nix"."CursorLine" = 62;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/flake.nix"."Dynamic Word Wrap" = true;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/flake.nix"."JumpList" = "";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/flake.nix"."TextFolding" = "{\"checksum\":\"1a217f110e44db45bd0ab114b5b6dc1cbd90f291\",\"ranges\":x5bx5d}";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/flake.nix"."ViMarks" = "";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/home-manager\\/home.nix"."CursorColumn" = 11;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/home-manager\\/home.nix"."CursorLine" = 112;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/home-manager\\/home.nix"."Dynamic Word Wrap" = true;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/home-manager\\/home.nix"."JumpList" = "";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/home-manager\\/home.nix"."TextFolding" = "{\"checksum\":\"b30dacfd2d8f96ef3f5b89b5fbe2ca0b566db4c2\",\"ranges\":x5bx5d}";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/home-manager\\/home.nix"."ViMarks" = "";
