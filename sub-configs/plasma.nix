...
{ config, lib, pkgs, plasma-manager, ... }:
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-851fa1c9-2c17-4808-bbb2-4ae1dafea8a5" = [ ];
      ...
      "kwin"."Expose" = "Ctrl+F9";
      "kwin"."ExposeAll" = [ "Launch (C)" "Ctrl+F10" "Ctrl+Tab" ];
      ...
      "kwin"."Window Minimize" = [ "Meta+PgDown" "Meta+Num+5" ];
      "kwin"."Window Move" = [ ];
      ...
      "kwin"."Window Pack Up" = [ ];
      "kwin"."Window Quick Tile Bottom" = [ "Meta+Num+2" "Meta+Down" ];
      "kwin"."Window Quick Tile Bottom Left" = "Meta+Num+1";
      "kwin"."Window Quick Tile Bottom Right" = "Meta+Num+3";
      "kwin"."Window Quick Tile Left" = [ "Meta+Num+4" "Meta+Left" ];
      "kwin"."Window Quick Tile Right" = [ "Meta+Right" "Meta+Num+6" ];
      "kwin"."Window Quick Tile Top" = [ "Meta+Num+8" "Meta+Up" ];
      "kwin"."Window Quick Tile Top Left" = "Meta+Num+7";
      "kwin"."Window Quick Tile Top Right" = "Meta+Num+9";
      "kwin"."Window Raise" = [ ];
      "kwin"."Window Resize" = [ ];
      "kwin"."Window Shade" = [ ];
    ...
    configFile = {
      ...
      "baloofilerc"."General"."exclude folders[$e]".value = "$HOME/code/,$HOME/result/,$HOME/tmp/,/home/kt/";
      "baloofilerc"."General"."folders[$e]".value = "$HOME/";
      "dolphinrc"."CreateDialog"."LastMimeType".value = "application/zip";
      ...
      "dolphinrc"."Open-with settings"."History".value = "code";
      "dolphinrc"."Search"."Location".value = "Everywhere";
      "kactivitymanagerdrc"."activities"."851fa1c9-2c17-4808-bbb2-4ae1dafea8a5".value = "Default";
      "kactivitymanagerdrc"."main"."currentActivity".value = "851fa1c9-2c17-4808-bbb2-4ae1dafea8a5";
      "kcminputrc"."Mouse"."X11LibInputXAccelProfileFlat".value = true;
      "kcminputrc"."Mouse"."cursorTheme".value = "breeze_cursors";
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size".value = "858,598";
      ...
      "kdeglobals"."General"."font".value = "Iosevka Carl,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."menuFont".value = "Iosevka Carl,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."smallestReadableFont".value = "Iosevka Carl,8,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."toolBarFont".value = "Iosevka Carl,10,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."KFileDialog Settings"."Speedbar Width".value = 152;
      ...
      "kdeglobals"."WM"."activeFont".value = "Iosevka Carl,10,-1,5,50,0,0,0,0,0";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{e4cc6b31-957e-4e71-a109-b67a5571f9c8}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{7b30280d-35ef-4973-b35f-398d7de86fea}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{59aedd0b-ae1e-4d37-9471-e01caac8a541}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{68c062d4-7155-4683-a9b7-e3a4db159b16}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{e502e859-dbff-4873-92ac-cbea127a1281}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{6d7a6ef4-dcef-423b-aa19-56933e419c18}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{48570aa2-180f-4ab0-b22c-cecc1a3fcbd4}";
      ...
      "kwinrc"."Desktops"."Id_1".value = "d90dc964-33dc-4d8b-81d9-c3b415496deb";
      "kwinrc"."Desktops"."Number".value = 1;
      "kwinrc"."Desktops"."Rows".value = 1;
      "kwinrc"."Plugins"."bismuthEnabled".value = true;
      "kwinrc"."Script-bismuth"."keepFloatAbove".value = false;
      "kwinrc"."Script-bismuth"."monocleMaximize".value = false;
      "kwinrc"."Tiling"."padding".value = 4;
      "kwinrc"."Tiling/12039571-9e9b-5df8-8882-3414c0f40eb0"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/1237bd4e-470f-5e67-a1cf-ea18e186beb4"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/1fecc0b8-69fd-5abc-9e49-a83c895f84e1"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/23217716-59ec-5120-9da5-a054ff23237f"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/288c1323-146c-5b91-aedb-28e6a1f44335"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/37bb9a2a-1a3c-5d70-a8a1-a1b646d1a364"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/3e34a5f9-d669-5059-b45b-c9aa4f727a6b"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/4ab09e28-d25f-5fe9-b3c5-90d7631283a7"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/51c2a236-39e6-569b-a5e1-7221baf7844c"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/53d35ef4-9b9e-5bcf-a909-f781022bf6d0"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/5ad081bd-ed6a-5a88-b022-4946423ba8b4"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/69efae36-27df-5591-b7de-a4b78febe4d9"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/6e9b316a-0014-5ee4-b775-354e103f5a7b"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/af27b85e-dd94-5962-b37d-6b9ea60123cb"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e64208a4-41e2-5bf1-8b57-3db9452f77d3"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/ea674178-f322-5ecf-b0bd-e548a306adaa"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/efd7cf71-e756-5c42-9142-12eabca39b01"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/faaaf558-b3c2-5ffa-b3b5-7615a0d84076"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/fbef7acd-3b88-5bfe-8917-4d938b20964a"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kxkbrc"."Layout"."LayoutLoopCount".value = "-1";
      "kxkbrc"."Layout"."Model".value = "pc86";
      "kxkbrc"."Layout"."Options".value = "terminate:ctrl_alt_bksp,compose:rctrl";
      "kxkbrc"."Layout"."ResetOldOptions".value = true;
      "kxkbrc"."Layout"."SwitchMode".value = "Global";
      "kxkbrc"."Layout"."Use".value = true;
      "kxkbrc"."Layout"."VariantList".value = "colemak";
      "plasma-localerc"."Formats"."LANG".value = "en_US.UTF-8";
      "plasma-localerc"."Formats"."LC_MEASUREMENT".value = "en_DK.UTF-8";
      "plasma-localerc"."Formats"."LC_TIME".value = "en_CA.UTF-8";
      "plasmarc"."Wallpapers"."usersWallpapers".value = "/home/carl/Pictures/_DSC2544-ARW-desktop.png,/home/carl/Pictures/_DSC5937-ARW_DxO.jpg,/home/carl/Pictures/_DSC9058.jpg";
