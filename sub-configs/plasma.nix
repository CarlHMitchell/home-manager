{ config, lib, pkgs, plasma-manager, ... }:
{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "eDP-1=1;DP-1=1;HDMI-1=1;DP-2=1;DP-3=1;DP-4=1;DP-5=1;";
      ...
      "kwinrc"."Tiling/6b252c5c-fb6e-5a7d-b9bf-2c6d362e3df7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/a1c18174-a5fa-52cf-adfb-84066eaec20d"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/flake.nix"."TextFolding" = "{\"checksum\":\"1a217f110e44db45bd0ab114b5b6dc1cbd90f291\",\"ranges\":[]}";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/carl\\/tmp\\/nix_config\\/home-manager\\/home.nix"."TextFolding" = "{\"checksum\":\"b30dacfd2d8f96ef3f5b89b5fbe2ca0b566db4c2\",\"ranges\":[]}";
